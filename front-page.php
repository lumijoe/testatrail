...
<div class="l-main-inner">
    ...
    <section class="l-firstview">
        <img src="https://dummyimage.com/1400x600/d9d9d9/fff" alt="" style="object-fit: cover; width: 100%; height: 100%;">
        <!-- <img src="https://dummyimage.com/1400x600/d9d9d9/fff" alt=""> -->
        <!-- <picture class="p-responsive-picture">
                <source media="(min-width:768px)" srcset="./images/home/pc/img_hero_pc.jpg 1x, 
                ./images/home/pc/img_hero_pc.jpg 2x">
                <source media="(max-width:767px)" srcset="./images/home/sp/img_hero_sp_compress.png 1x">
    ...
    <section class="l-nav">
        <nav class="p-nav">
            <ul>
                <li><a href="https://lkcodetest.sakura.ne.jp/testatrail/#service">事業案内</a></li>
                <li><a href="https://lkcodetest.sakura.ne.jp/testatrail/#work">施工事例</a></li>
                <li><a href="https://lkcodetest.sakura.ne.jp/testatrail/#company">会社概要</a></li>
                <li><a href="https://lkcodetest.sakura.ne.jp/testatrail/#contact">お問い合わせ</a></li>
            </ul>
        </nav>
    </section>
    <!----------------------------------
        ...
        ----------------------------------->
    <section class="l-catchcopy" id="service">
        <h3 class="p-catchcopy">（ダミー）コンテナハウスで理想の暮らしをかなえます</h3>
    </section>
    <!----------------------------------
        gallery
        ----------------------------------->
    ...
    <!----------------------------------
        work
        ----------------------------------->
    <section class="l-work-section" id="work">
        <div class="l-section-inner l-section-inner-plf--20px l-work-section-inner">
            <h3 class="p-section_ttl--pb32">施工事例</h3>
            <ul class="l-work-box">
                <li class="l-work-box_card">
                    <img src="https://dummyimage.com/295x295/d9d9d9/fff" alt="">
                    <div>
                        <caption>2024.00 竣工</caption>
                        <p>コンテナハウス住宅</p>
                    </div>
                    <div class="card_btn-wrapper">
                        <button><a href="./">詳しくは→</a></button>
                    </div>
                </li>
                <li class="l-work-box_card">
                    <img src="https://dummyimage.com/295x295/d9d9d9/fff" alt="">
    ...
    <!----------------------------------
        ...
        ----------------------------------->
    <section class="l-cta">
        <button class="p-cta-btn"><a href="#contact">お問い合わせ→</a></button>
    </section>
    <!----------------------------------
        news
        ----------------------------------->
    <section class="l-news">
        <div class="l-news-inner l-section-inner-plf--20px l-section-inner">
            <h3 class="p-section_ttl--pb32">お知らせ</h3>
            <div class="l-news-box">
                <ul>
                    <li>
                        <time>2024年3月3日</time>
                        <a href="./">施工事例を更新しました</a>
                    </li>
                    <li>
                        <time>2024年9月12日</time>
                        <a href="./">夏季休暇のお知らせ</a>
                    </li>
                    <li>
                        <time>2024年1月6日</time>
